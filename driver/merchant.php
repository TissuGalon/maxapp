...
<body>
    ...
    $produk = mysqli_query($conn, "SELECT * FROM produk WHERE id_merchant = '$id'");
            ...
            <div class="container">
                <div class="d-flex align-items-start">
                    ...
                    <div class="vendor-info">
                        ...
                        <div class="ratings lh-1">
                            <?php
                            $starav = mysqli_query($conn, "SELECT AVG(bintang) AS avg FROM ulasan_produk WHERE id_merchant='$id'");
                ...
                <div class="vendor-basic-info d-flex align-items-center justify-content-between mt-4">
                    <div class="single-basic-info">
                        ...
                        if ($trusted) {
                            ?>
                            <div class="icon"><i class="fa-solid fa-shield me-1"></i></div><span>Trusted Seller</span>
                        <?php } ?>
                    ...
                    <div class="single-basic-info">
                        <?php
                        $cek_ulasan = mysqli_query($conn, "SELECT * FROM ulasan_produk WHERE id_merchant='$id'");
                            ...
                            <div class="col-4 col-md-4">
                                <div class="card product-card">
                                        ...
                                        <a class="product-thumbnail d-block"
                                            ...
                                            <div class=" rounded " style="height:100px;width:auto;overflow:hidden;"><img style="width:auto; height:100%;" class="mb-2 rounded" 
                                                src="../img/product/<?php echo $vw['gambar'] ?>" alt="<?php echo $vw['nama_produk'] ?>">
                                            </div>                                   
                                        </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Product Title -->
                                        <a class="product-title mt-0" href="single-product.html">
                                            <?php echo $vw['nama_produk'] ?>
                                        </a>
                                        <!-- Product Price -->
                                        <p class="sale-price">Rp.
                                            <?php echo $vw['harga'] ?><span></span>
                                        </p>
                                        <!-- Rating -->
                                        <div class="product-rating">
                                            <?php
                                            $bintang = 1;
                                            while ($bintang <= $vw['bintang']) { ?>
                                                <i class="fa-solid fa-star"></i>
                                                <?php $bintang++;
                                            } ?>
                                        </div>
                                        ...
                                        <!-- <a class="btn btn-success btn-sm"
                                            href="edit-produk.php?id=<?php echo $vw['id_produk'] ?>"><i
                    ...
                    <div class="container">
                        <div class="rating-review-content">
                            <ul class="ps-0">
                                ...
                                $ulasan = mysqli_query($conn, "SELECT * FROM ulasan_produk WHERE id_merchant = '$id' ORDER BY waktu DESC  ");
