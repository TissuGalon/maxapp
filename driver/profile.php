...
<?php if($row['foto'] != '' || $row['foto'] != null){ ?>
  ...
  background-repeat: no-repeat; background-image: url('../img/driver-image/<?php echo $row['foto'] ?>')">
    ...
    <h4 class="text-center mt-3">Muhammad Kholis</h4>

    <div class="d-flex justify-content-center">
        <h6 class="btn btn-warning text-light btn-sm rounded-pill w-25 disabled"><i class="fa-solid fa-truck"></i> Driver</h6>
...
border: 1px solid rgba(255, 255, 255, 0.52); border-radius:20px;">
    ...
    <div class="card pb-5" style="border-radius:20px 20px 0px 0px; ">
        ...
        <div class="py-2"></div>
            ...
            <a href="edit-profile.php" class="text-secondary btn   text-dark w-100 py-3 my-1" style="background-color:#f5f7fa; border-radius:20px;">
            <div class="d-flex justify-content-between">
                <div>
                    <i class="fa-solid fa-user text-warning me-4 ms-2"></i> <small>Edit Profil</small> 
                </div>
