...
<body>
  ...
  <!-- Login Wrapper Area-->
  <div class="login-wrapper d-flex align-items-center justify-content-center text-center" style="background:#e9eeff;">
    <!-- Background Shape-->
          ...
          <div class="register-form mt-5 text-dark">
            <form method="POST">
              ...
              <div class="form-group text-start text-dark mb-4"><span class="text-dark">Password</span>
                <label for="password" class="text-secondary"><i class="fa-solid fa-key"></i></label>
                <input class="form-control pl2" style="color:black; border-bottom: 1px solid grey;" id="password" type="password" name="pass" placeholder="Password" required
                  max="50">
              </div>
              <button class="btn btn-warning btn-lg w-100 text-light rounded-pill shadow-sm" type="submit" name="submit">Log In <i class="fa-solid fa-key  ms-1"></i></button>
            </form>
          </div>
...
border: 1px solid rgba(255, 255, 255, 0.3);' href="login_driver.php"><i class="fa-solid fa-truck me-2"></i> Login Driver</a>
          <!-- Login Meta-->
          <div class="my-3"></div>
          <!-- View As Guest-->
          <div class="view-as-guest mt-1 mb-3"><a class="btn text-dark" href="index.php">Lanjutkan sebagai Tamu <i class="fa-solid fa-arrow-right ms-2"></i></a></div>

          <div class="fixed-bottom">
            <p class="mb-0 text-dark">Belum punya akun?<a class="mx-1 text-warning" href="register.php">Daftar Sekarang</a></p>
            <div class="login-meta-data"><a class="forgot-password d-block mt-2 mb-1 text-dark" href="forget-password.html">Lupa
                Password?</a>
            </div>
          </div>
