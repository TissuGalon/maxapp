...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            ...
            <div class="page-heading">
                <h6 class="mb-0"><i class="fa-solid fa-prescription-bottle-medical"></i> Obat Obatan</h6>
            </div>
            <!-- Filter Option-->
            <div></div>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="pt-3">
            <div class="container">
                <div class="catagory-single-img" style="background-image: url('img/medicine-banner.jpg')"></div>
            </div>
        </div>
            ...
            <div class="container pt-4">
                ...
                <div class="row g-2 rtl-flex-d-row-r mb-3">
                    ...
                    if(isset($_GET['sub']) && $_GET['sub'] == 'Makanan'){
                        ...
                        $produk = mysqli_query($conn, "SELECT * FROM produk WHERE jenis='obat' AND hapus = 'false'");
                    }
                    ?>
