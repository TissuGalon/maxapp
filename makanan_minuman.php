...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            ...
            <div class="page-heading">
                <h6 class="mb-0"><i class="fa-solid fa-burger"></i><i class="fa-solid fa-mug-hot m-1"></i> Makanan &amp; Minuman</h6>
            </div>
            <!-- Filter Option-->
            <div></div>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="pt-3">
            <div class="container">
                <div class="catagory-single-img" style="background-image: url('img/food-banner.png')"></div>
            </div>
        </div>
        ...
        <!-- Top Products-->
        <div class="top-products-area card" style="/* From https://css.glass */
