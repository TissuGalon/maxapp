                ...
                <div class="card user-data-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            if ($row['gambar'] == null) { ?>
                                <img id="image" width="120" src="img/product/10.png">
                            <?php } else { ?>
                                <img id="image" width="120" src="img/product/<?php echo $row['gambar'] ?>">
                            <?php } ?>


                        </div>
                        <div class="justify-content-center mt-3">
                            <form action="proses/upfoto_produk.php" method="POST" enctype="multipart/form-data">
                            ...
                            <form action="proses/update_produk.php" class="row" method="GET" id="submitform">
                                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"></input>
                            <div class="col-12 my-1">
                                <label><small class="text-dark">Nama Produk</small></label>
                                <input class="form-control text-dark" name="nama" value="<?php echo $row['nama_produk'] ?>"> 
                            </div>
                            <div class="col-6 my-1">
                                <label><small class="text-dark">Harga</small></label>
                                <input class="form-control text-dark" type="number" name="harga" value="<?php echo $row['harga'] ?>"> 
                            </div>
                            <div class="col-6 my-1">
                                <label><small class="text-dark">Stock</small></label>
                                <input type="number" class="form-control text-dark" name="stock" value="<?php echo $row['stock'] ?>"> 
                            </div>
                            <div class="col-6 my-1">
                                <label><small class="text-dark">Jenis</small></label>
                                <select class="form-select" name="jenis" onchange="tampil()" id="jenis">
                                    <option value="<?php echo $row['jenis'] ?>"><?php echo ucwords($row['jenis']) ?></option>
                            ...
                            <div class="col-6 my-1" id="form_subjenis" style="display:none;">
                                ...
                                <select class="form-select" name="subjenis">
                                    <option value="<?php echo $row['sub_jenis'] ?>"><?php echo ucwords($row['sub_jenis']) ?></option>
                            ...
                            <div class="col-12 my-1">
                                ...
                                <textarea class="form-control text-dark" rows="6" name="deskripsi"><?php echo $row['deskripsi'] ?></textarea>
                            </div>
                            <div class="col-12 my-1">
                                <input type="submit" style="display:none;" value="Update Produk" name="ubah"
                                        class="btn m-1 btn-warning btn-lg w-100 text-light">
                                </input>
                                <a class="btn btn-warning btn-lg text-light w-100 m-1" onclick="ask()">Update Produk</a>
                            </div>
                            </form>
