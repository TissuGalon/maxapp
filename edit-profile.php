...
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/toastify-js"></script>
  ...
  <div class="page-content-wrapper">
    ...
    $profil = mysqli_query($conn, "SELECT * FROM user WHERE username ='$username'");
  ...
  background-repeat: no-repeat; background-image: url('img/user-image/<?php echo $row['foto'] ?>')">
    ...
    <h6 class="text-center mt-1">@<?php echo $row['username'] ?></h6>
          ...
          <div class="card-body">
            <form>
              <div class=" mb-3">
                ...
                <input class="form-control" id="username" type="text" value="<?php echo $row['username'] ?>" disabled>
              </div>
              <div class="mb-3">
                <div class=" mb-2"><i class="fa-solid me-2 text-dark fa-user"></i><span class="text-dark">Nama Lengkap</span></div>
                <input class="form-control" id="nama" type="text" value="<?php echo $row['nama'] ?>">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <div class=" mb-2"><i class="fa-solid me-2 text-dark fa-location-arrow"></i><span class="text-dark">Alamat</span></div>
                <input class="form-control" id="alamat" type="text" value="<?php echo $row['alamat'] ?>">
              </div>
  ...
  <script>
    ...
    function ubah() {
      ...
      ajax.open("POST", "proses/edit-profil-user.php", true);
      ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
      ajax.send("email=" + email + "&username=" + username + "&nama=" + nama + "&nohp=" + nohp + "&alamat=" + alamat);
