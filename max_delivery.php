...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            <!-- Back Button-->
            <div class="back-button me-2"><a href="index.php"><i
                        class="fa-solid fa-arrow-left-long"></i></a></div>
            <!-- Page Title-->
            <div class="page-heading">
                <h6 class="mb-0">Max Delivery</h6>
            </div>
            <!-- Navbar Toggler-->
                        ...
                        <div class="rating-and-review-wrapper dir-rtl">
                            <div class="pt-1">
                                ...
                                <div class="bg-white card mb-2 shadow-sm mt-1">
                                    <div class="m-2">
                                        <form>
                                            <label for="pesanan" class="text-secondary m-2">Pesanan : </label>
                                            <textarea class="form-control" name="" id="pesanan" rows="6" required></textarea>
                                            <div class="d-flex justify-content-end">
                                                <input type="submit" name="kirim" value="Pesan" class="btn btn-warning text-light mt-3 w-25"></input>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white p-2 rounded" style="height:100%;">
                                ...
                                <div class="d-flex justify-content-between mx-2 mt-1">
                                    <small class="text-dark m-2"><?php echo $jmlproduk ?> <span class="ms-1">Driver</span></small>
                                ...
                                <div class="row g-2 bg-white mt-2 mx-0 " >
                                    ...
                                    <div class="col-12 pt-1  mt-1" >
                                        <div class="horizontal-product-card shadow-sm p-1" style="border-radius:10px; border-style:solid; border-color:#efefef;">
                                            ...
                                            <!-- Thumbnail -->
                                            <!-- GAMBAR -->
                                            <div class="m-1" style="height:70px;width:70px;overflow:hidden;border-radius:50%; border:1px solid orange; background-position: center; background-size:cover;
                                background-repeat: no-repeat; background-image: url('img/user-image/avatar.svg')">
                                            </div>    
                                            <!-- GAMBAR -->
                                        </div>
                                        <div class="product-description p-1">
                                            ...
                                            <a class="btn btn-warning text-light float-end m-1"
                                            href="produk_edit.php?id=<?php echo $row['id_produk'] ?>"><i class="fa-solid fa-check me-2"></i> Pilih</a>
